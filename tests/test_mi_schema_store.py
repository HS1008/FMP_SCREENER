...
def test_new_migrations_are_additive_and_numbered_after_007():
    ...
    new = [n for n in names if n.startswith(("008", "009", "010", "011", "012", "013", "014", "015", "016", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026", "027", "028", "029", "030", "031", "032", "033", "034", "035", "036", "037", "038"))]
    assert new == [
    ...
    for name in new:
        ...
        for statement in split_sql_statements((MIGRATIONS / name).read_text(encoding="utf-8")):
            assert statement.upper().startswith(
                (
                    "CREATE TABLE IF NOT EXISTS MI_",
                    "CREATE INDEX IF NOT EXISTS",
                    "CREATE UNIQUE INDEX IF NOT EXISTS",
                    "CREATE OR REPLACE VIEW MI_V_",
                    "COMMENT ON",
                    "ALTER TABLE MI_",
                    "ALTER TABLE RESEARCH_",
