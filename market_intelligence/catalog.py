...
SOURCE_REGISTRY_DEFAULTS: tuple[dict, ...] = (
    ...
    },
    {
        ...
        "dataset": "eia_v2_catalog",
        "source_url": "https://api.eia.gov/v2",
        "expected_cadence": "MIXED",
        "usage_scope": EXPORT_ATTRIBUTION_REQUIRED,
        "attribution": "U.S. Energy Information Administration API v2.",
        "terms_notes": "Credential presence is not activation. MI_EIA_ENABLED must be explicit. Hub power prices are UNAVAILABLE in v1.",
        "units_metadata": {"per_series": True},
    },
    {
        "source_id": "CFTC_COT",
        "provider": "U.S. Commodity Futures Trading Commission",
        "dataset": "cot_futures_only",
        "source_url": "https://publicreporting.cftc.gov",
        "expected_cadence": "W",
        "usage_scope": EXPORT_ATTRIBUTION_REQUIRED,
        "attribution": "CFTC Public Reporting Environment (futures-only TFF and Disaggregated COT).",
        "terms_notes": "Combined futures+options reports are catalogued and never summed with futures-only.",
        "units_metadata": {"positions": "contracts"},
    },
    {
        "source_id": "OPENFIGI",
        "provider": "OpenFIGI",
        ...
        "expected_cadence": "ON_DEMAND",
        "usage_scope": EXPORT_ATTRIBUTION_REQUIRED,
        "attribution": "OpenFIGI mapping (Bloomberg FIGI).",
        "terms_notes": "Mapper only; not an authoritative universe. Ambiguous matches are quarantined.",
        "units_metadata": {},
    },
    {
        ...
        "terms_notes": "Writer ingestion only. MI_CBOE_ENABLED is required. Streamlit does not call Cboe. Trial point budget is enforced per run.",
