...
def atm_iv_for_expiry(contracts: Iterable[NormalizedContract], spot: Decimal) -> dict[str, Any]:
    ...
    return {
        ...
        "strike": strike,
        "sided": sided,
        "one_sided": sided != "both",
        "call_iv_decimal": sides["call"].iv_decimal if "call" in sides else None,
        "put_iv_decimal": sides["put"].iv_decimal if "put" in sides else None,
        "call_iv_percent": (sides["call"].iv_decimal * Decimal("100")) if "call" in sides else None,
        "put_iv_percent": (sides["put"].iv_decimal * Decimal("100")) if "put" in sides else None,
        "combined_iv_decimal": iv,
        "combined_iv_percent": iv * Decimal("100"),
        "status": "OK",
        "label": "spot_atm",
        "rule": ATM_RULE,
        "reason": None,
