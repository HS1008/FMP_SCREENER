...
| Streamlit pages 10-19 (Market Pulse, Macro, Rates, Credit, Sector Rotation V2, Data Health, Morning Context, PIT Sector Internals, Order Flow, Fixed Income) | IMPLEMENTED_AND_TESTED (AppTest populated / empty / unconfigured) | `pages/1*.py`, `pages_ui.py` | `DATABASE_READONLY_URL`; no writer fallback |
...
`PROVIDER_SUPPORT_REQUIRED`, `RIGHTS_PENDING`, `NOT_CONFIGURED`.
