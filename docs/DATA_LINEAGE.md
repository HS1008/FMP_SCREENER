...
| CFTC COT | CFTC | `CftcCotAdapter` | off | none | Commodities, Data Health | none | NOT_CONFIGURED | weekly if added |
| EIA energy | EIA | `EiaEnergyAdapter`; Power Producers cache | off for MI | none in MI | Commodities, Power Producers | FRED WTI/HH/copper | NOT_CONFIGURED | publication |
