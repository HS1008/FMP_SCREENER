-- Yahoo volatility read models. Metrics live in mi_metric_snapshots (category YAHOO_VOL).
-- Additive. Does not edit applied SQL. Does not touch research or holdout tables.

CREATE OR REPLACE VIEW mi_v_yahoo_vol_latest AS
