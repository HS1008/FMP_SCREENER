...
SELECT EXISTS (SELECT 1 FROM information_schema.views WHERE table_name = 'mi_v_live_quotes_by_source') AS has_live_quotes \gset
\if :has_live_quotes
GRANT SELECT ON mi_v_live_quotes_by_source TO mi_readonly;
